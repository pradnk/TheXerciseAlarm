package com.blogspot.abtandroid.exercisealarm.socialnetwork;
...
import com.blogspot.abtandroid.exercisealarm.Constants;
import com.blogspot.abtandroid.exercisealarm.util.Profile;
...
public class FacebookSocialNetwork extends SocialNetwork {
		...
		if(isAuthenticated()) {
			...
			if (facebook.isSessionValid()) {
				...
				AsyncFacebookRunner mAsyncRunner = new AsyncFacebookRunner(
						facebook);
	            mAsyncRunner.request("me/feed", params, "POST", new WallPostRequestListener(), "State");
			} else {
	...
	public class WallPostRequestListener extends BaseRequestListener {
        ...
        public void onComplete(final String response) {
            Log.e(Constants.APP_NAME, "Got response: " + response);
            Toast.makeText(context, "Successfully shared on Facebook", Toast.LENGTH_LONG).show();
        }
		...
		public void onComplete(String response, Object state) {
			...
			try {
				...
				if(responseJSON.has("id")) {
					System.out.println("POSTID: "+responseJSON.getString("id")+" "+state);
...
//					SharedPreferenceManager sharedPreferenceManager = new SharedPreferenceManager(TheXerciseAlarmActivity.getAppThrowerApplicationContext());
