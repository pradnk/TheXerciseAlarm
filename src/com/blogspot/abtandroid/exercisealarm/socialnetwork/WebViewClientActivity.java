		...
		if(isFacebook) {
			facebook.authorize(this, new String[]{"read_stream, publish_stream"}, new DialogListener() {
	            ...
	            public void onComplete(Bundle values) {
	            	FacebookSocialNetwork socialNetwork = new FacebookSocialNetwork(WebViewClientActivity.this);//(FacebookSocialNetwork)SocialNetwork.getProvider(SocialNetwork.SOCIAL_NETWORK_FACEBOOK);
